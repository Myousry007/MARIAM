...
! function(i) {
    ...
    i("#preloader").fadeOut("normall", function() {
        ...
        e <= 50 ? (i("header").removeClass("scrollHeader").addClass("fixedHeader"), a.attr("src", "img/logo.png")) : (i("header").removeClass("fixedHeader").addClass("scrollHeader"), a.attr("src", "img/logo.png")), t.attr("src", "img/logo.png"), o.attr("src", "img/logo.png")
    }), s.on("scroll", function() {
